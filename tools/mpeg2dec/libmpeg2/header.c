...
static int picture_coding_ext (mpeg2dec_t * mpeg2dec)
{
    ...
    is_tff = picture->flags & PIC_FLAG_TOP_FIELD_FIRST ? 1 : 0;
    is_rff = picture->flags & PIC_FLAG_REPEAT_FIRST_FIELD ? 1 : 0;
    is_prog = picture->flags & PIC_FLAG_PROGRESSIVE_FRAME ? 1 : 0;
